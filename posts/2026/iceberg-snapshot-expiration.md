...
![Iceberg snapshot lifecycle and expiration workflow](/images/iceberg-snapshot-expiration-lifecycle.png)
...
![Iceberg table health metrics monitoring](/images/iceberg-table-health-monitoring.png)
