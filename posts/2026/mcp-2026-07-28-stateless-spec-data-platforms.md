...
![Papercut MCP host, client, stateless server pool, and lakehouse resources architecture](/images/mcp-2026-07-28-stateless-spec-data-platforms-diagram-1.png)
...
![Papercut tool call lifecycle with identity, consent, policy, query, result, and audit](/images/mcp-2026-07-28-stateless-spec-data-platforms-diagram-2.png)
...
![Papercut Agentic Lakehouse stack with MCP interface layer above governed tools, semantic layer, query, catalog, Iceberg tables, and storage](/images/mcp-2026-07-28-stateless-spec-data-platforms-diagram-3.png)
