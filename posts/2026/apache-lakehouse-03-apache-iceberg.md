...
![The Iceberg Metadata Tree showing the path from Catalog down to Data Files](/images/apache-lakehouse-03-apache-iceberg-iceberg-metadata-tree.png)
...
![Diagram showing Schema Evolution mapping unique column IDs to file structures over time](/images/apache-lakehouse-03-apache-iceberg-iceberg-schema-evolution.png)
...
![Diagram showing Time Travel snapshots pointing an overlapping set of underlying Parquet files](/images/apache-lakehouse-03-apache-iceberg-iceberg-time-travel.png)
