...
date: "2026-07-06"
description: "Open table formats changed the data lakehouse conversation, but they did not finish it. A table can be stored in an open format and still be hard to g"
author: "Alex Merced"
category: "Lakehouse"
tags:
  - lakehouse
...
![Papercut architecture showing a central open catalog hub connected to multicloud lakehouse zones and engines](/images/week-2026-07-06/multi-engine-catalog-federation-apache-polaris-multicloud-diagram-1.png)
...
![Papercut diagram showing identity and role mapping across policy gateway and cloud zones](/images/week-2026-07-06/multi-engine-catalog-federation-apache-polaris-multicloud-diagram-2.png)
...
![Papercut open lakehouse governance model with shared catalog, query federation, semantic layer, and clients](/images/week-2026-07-06/multi-engine-catalog-federation-apache-polaris-multicloud-diagram-3.png)
