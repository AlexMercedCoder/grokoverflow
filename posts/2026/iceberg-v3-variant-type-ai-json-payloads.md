...
![Layered papercut diagram showing nested AI payloads flowing into an Iceberg table with promoted governed columns](/images/wk-jul06/iceberg-v3-variant-type-ai-json-payloads-./diagram-1.png)
...
![Layered papercut lifecycle showing raw nested payloads becoming validated curated semantic data](/images/wk-jul06/iceberg-v3-variant-type-ai-json-payloads-./diagram-2.png)
...
![Layered papercut diagram showing multiple engines and tools accessing semi-structured Iceberg data through governance](/images/wk-jul06/iceberg-v3-variant-type-ai-json-payloads-./diagram-3.png)
