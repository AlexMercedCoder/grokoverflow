...
![Windsurf AI editor with Cascade agent connecting to Dremio Agentic Lakehouse via MCP](/images/2026/aitoolblogs/windsurf/windsurf-dremio-architecture.png)
...
![Four approaches to connecting AI coding tools to Dremio](/images/2026/aitoolblogs/windsurf/four-integration-approaches.png)
