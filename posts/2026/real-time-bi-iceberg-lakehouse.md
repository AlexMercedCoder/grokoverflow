...
![Real-time BI architecture on Apache Iceberg with Dremio](/images/real-time-bi-iceberg-architecture.png)
...
![Dremio query acceleration layers for Iceberg BI](/images/dremio-query-acceleration-layers.png)
