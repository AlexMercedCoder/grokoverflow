...
![Agentic lakehouse concurrency and isolation architecture](/images/agentic-lakehouse-concurrency.png)
...
![Multi-agent isolation snapshot model diagram](/images/multi-agent-isolation-snapshots.png)
