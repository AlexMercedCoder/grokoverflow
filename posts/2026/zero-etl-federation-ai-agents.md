...
![Zero-ETL federation architecture for AI agents](/images/zero-etl-federation-architecture.png)
...
![Zero-ETL vs traditional ETL federation decision matrix](/images/zero-etl-vs-etl-decision.png)
