...
![Stages: ingest raw data, validate in staging, apply business logic, serve to consumers](/images/2026/debp/02-design-data-pipelines/four-layers.png)
...
![Failure handling: retry, dead-letter queue, circuit breaker, checkpoint](/images/2026/debp/02-design-data-pipelines/failure-patterns.png)
