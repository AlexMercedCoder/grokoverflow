...
This is Part 4 of a 10-part series on query engine design. [Part 3](/posts/2026/query-engine-optimization-03-data-organization-on-disk) covered how data is structured within files. This article covers the auxiliary data structures that make lookups fast: indexes.
...
![B-tree structure showing root, internal, and leaf nodes with point lookup and range scan paths](/images/query-engine-optimization-04-indexing-strategies-btree-structure.png)
...
![LSM tree write path from memtable through WAL flush to SSTables across multiple levels with compaction](/images/query-engine-optimization-04-indexing-strategies-lsm-tree-write-path.png)
...
![Index type tradeoff matrix comparing read speed, write cost, memory cost, and best use case for B-trees, LSM trees, bitmap indexes, bloom filters, and zone maps](/images/query-engine-optimization-04-indexing-strategies-index-tradeoff-matrix.png)
