...
This is Part 7 of a 10-part series on query engine design. [Part 6](/posts/2026/query-engine-optimization-06-execution-models) covered execution models. This article covers how engines manage their most precious resource: memory.
...
![Cache hit versus cache miss latency showing the 1000x gap between RAM and SSD access](/images/query-engine-optimization-07-memory-and-caching-cache-hit-miss-latency.png)
...
![Buffer pool architecture showing shared memory pages, page table, cache hits, and background writes to disk](/images/query-engine-optimization-07-memory-and-caching-buffer-pool-architecture.png)
...
![How engines divide available memory between data cache, sort buffers, hash tables, and network buffers](/images/query-engine-optimization-07-memory-and-caching-memory-budget-allocation.png)
