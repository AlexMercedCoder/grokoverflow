...
* [Part 1: Apache Software Foundation: History, Purpose, and Process](/posts/2026/apache-lakehouse-01-apache-software-foundation)
...
![Diagram showing multiple query engines connecting to Apache Polaris via REST API, pointing to S3 storage](/images/apache-lakehouse-04-apache-polaris-polaris-rest-api.png)
...
![Credential vending flow showing Engine, Polaris RBAC check, temporal token, and S3 access](/images/apache-lakehouse-04-apache-polaris-polaris-credential-vending.png)
...
![Diagram showing Apache Polaris serving as the neutral governing body spanning different clouds and engines](/images/apache-lakehouse-04-apache-polaris-polaris-neutral-catalog.png)
