...
![Iceberg scan planning cascade showing how metadata progressively eliminates files at each stage](/images/apache-iceberg-masterclass-03-iceberg-metadata-performance-scan-planning-cascade.png)
...
![Three layers of data skipping showing partition pruning, file pruning, and the final result](/images/apache-iceberg-masterclass-03-iceberg-metadata-performance-pruning-example.png)
...
![Per-file statistics tracked in Iceberg manifest entries](/images/apache-iceberg-masterclass-03-iceberg-metadata-performance-per-file-statistics.png)
...
2. **Consider partition evolution** (covered in [Part 4](/posts/2026/apache-iceberg-masterclass-04-partition-evolution)) to add a partition transform on the column.
