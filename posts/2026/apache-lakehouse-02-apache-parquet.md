...
![Diagram showing Row-Based vs Column-Based physical storage on disk](/images/apache-lakehouse-02-apache-parquet-row-vs-columnar-storage.png)
...
![Diagram of Dictionary Encoding mapping text strings to small integer identifiers](/images/apache-lakehouse-02-apache-parquet-parquet-dictionary-encoding.png)
...
![Diagram of Predicate Pushdown showing the engine skipping a row group based on min/max stats](/images/apache-lakehouse-02-apache-parquet-parquet-predicate-pushdown.png)
