...
This is Part 2 of a 15-part [Apache Iceberg Masterclass](/posts/2026/apache-iceberg-masterclass-01-table-formats). [Part 1](/posts/2026/apache-iceberg-masterclass-01-table-formats) covered why table formats exist. This article breaks down exactly how each format organizes its metadata.
...
![Iceberg's three-layer metadata architecture from catalog to metadata.json to manifest list to manifest files to data files](/images/apache-iceberg-masterclass-02-metadata-structures-iceberg-metadata-tree.png)
...
![Delta Lake's transaction log structure with JSON commits, Parquet checkpoints, and the reader process](/images/apache-iceberg-masterclass-02-metadata-structures-delta-lake-transaction-log.png)
...
![Five approaches to table metadata from file-based to database-backed](/images/apache-iceberg-masterclass-02-metadata-structures-metadata-architecture-comparison.png)
...
[Part 3](/posts/2026/apache-iceberg-masterclass-03-iceberg-metadata-performance) covers how query engines use Iceberg's metadata specifically for performance optimization.
