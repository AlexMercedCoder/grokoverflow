...
date: "2026-07-06"
description: "AI agents change the security model for analytics. A human user may run a handful of queries, pause, interpret the answer, and ask a follow-up. An age"
author: "Alex Merced"
category: "Lakehouse"
tags:
  - lakehouse
...
![Papercut agent identity flowing through MCP, policy, query engine, catalog, and lakehouse data](/images/week-2026-07-06/fine-grained-security-machine-speed-ai-agents-diagram-1.png)
...
![Papercut fine-grained policy checks for row, column, metric, and tool access](/images/week-2026-07-06/fine-grained-security-machine-speed-ai-agents-diagram-2.png)
...
![Papercut audited AI agent loop inside governed lakehouse architecture](/images/week-2026-07-06/fine-grained-security-machine-speed-ai-agents-diagram-3.png)
