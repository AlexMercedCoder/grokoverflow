...
![Three pillars: metrics tracking counts and timing, logs recording execution details, lineage mapping data flow](/images/2026/debp/09-observability-monitoring/three-pillars.png)
...
![Alert severity levels: critical triggers pages, warning goes to channel, info logged](/images/2026/debp/09-observability-monitoring/alert-levels.png)
