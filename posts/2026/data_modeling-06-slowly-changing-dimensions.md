...
![SCD Type 2 showing multiple rows for the same entity with effective and expiry dates](/images/2026/data_modeling/06-slowly-changing-dimensions/scd-type-2.png)
...
![Choosing between SCD types based on reporting requirements and complexity tolerance](/images/2026/data_modeling/06-slowly-changing-dimensions/scd-decision-guide.png)
