...
![Spectrum from batch to streaming with example use cases at each latency level](/images/2026/debp/06-batch-vs-streaming/latency-spectrum.png)
...
![Decision framework: start batch, upgrade to micro-batch, stream only when sub-second needed](/images/2026/debp/06-batch-vs-streaming/decision-framework.png)
