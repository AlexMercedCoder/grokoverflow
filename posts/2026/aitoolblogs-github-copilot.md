...
![GitHub Copilot agent mode in VS Code connecting to Dremio Agentic Lakehouse via MCP](/images/2026/aitoolblogs/github-copilot/copilot-dremio-architecture.png)
...
![Four approaches to connecting AI coding tools to Dremio](/images/2026/aitoolblogs/github-copilot/four-integration-approaches.png)
