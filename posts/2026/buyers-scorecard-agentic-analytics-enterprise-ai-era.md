...
![Papercut five-part buyer scorecard wheel for agentic analytics](/images/buyers-scorecard-agentic-analytics-enterprise-ai-era-diagram-1.png)
...
![Papercut comparison of simple demo chatbot versus production analytics agent architecture](/images/buyers-scorecard-agentic-analytics-enterprise-ai-era-diagram-2.png)
...
![Papercut open lakehouse evaluation model for agentic analytics with governance, semantics, federation, observability, cost, and action safety](/images/buyers-scorecard-agentic-analytics-enterprise-ai-era-diagram-3.png)
