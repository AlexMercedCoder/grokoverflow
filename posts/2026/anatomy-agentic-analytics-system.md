...
![Agentic analytics system architecture diagram ReAct loop](/images/agentic-system-architecture.png)
...
![Agentic analytics self-correction error handling flow](/images/agentic-self-correction-flow.png)
