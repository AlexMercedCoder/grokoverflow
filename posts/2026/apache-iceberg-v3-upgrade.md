...
![Apache Iceberg v3 table format architecture diagram](/images/iceberg-v3-architecture.png)
...
![Iceberg deletion vectors vs positional delete files comparison](/images/iceberg-deletion-vectors-comparison.png)
